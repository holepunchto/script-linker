...
module.exports = class Module {
  ...
  toESM () {
    ...
    if (e) {
      ...
      if (e.default) {
        out += 'export default (typeof mod === \'object\' && mod && mod.__esModule && mod.default !== undefined)'
        out += ' ? (typeof mod.default === \'function\' ? mod.default.bind(mod) : mod.default)'
        out += ' : mod\n'
      }
    }
  ...
  _wrapBuiltin (mod) {
    let src = `const mod = ${this.linker._ns}require(${JSON.stringify(this.filename)})\n`
