...
module.exports = class Module {
  ...
  addCJSExports (list) {
    ...
    for (const name of list) this._cjsExports.add(name)
  }
  ...
  toESM () {
    ...
    for (const key of this.getCJSExports()) {
      if (key === '__mod__' || !isValidVariable(key)) continue
  ...
  async _refresh () {
    ...
    const mod = (stat && stat.resolutions)
      ? { type: info.type, resolutions: stat.resolutions, namedImports: [], exports: stat.exports || null }
