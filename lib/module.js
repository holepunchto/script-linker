...
module.exports = class Module {
  ...
  get exports () { // lazy as it's not always used
    ...
    try {
      if (!this._module.exports) {
        this._module.exports = parse.exports(this.source, this.type, { defines: compat.isPreact(this.name) })
      }
    } catch {}
  ...
  toESM () {
    ...
    out += 'const __mod__ = ' + requireFromSource(this.linker._ns, this.linker.mapPath(this.filename), this.toCJS()) + '\n'
    ...
    out += '//# sourceURL=' + this.linker.mapPath(this.filename) + '+esm-wrap'
